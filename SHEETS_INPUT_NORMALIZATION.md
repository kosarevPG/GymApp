...
## Легенда для колонки Type (REF_Exercises)

| Type | Описание | Формула | Что вводит пользователь |
|------|----------|---------|--------------------------|
| **Barbell** | Штанга / Смит | Ввод × 2 + База | Вес блинов с одной стороны |
| **Dumbbell** | Гантели | Ввод | Вес одной гантели |
| **Plate_Loaded** | Рычажные тренажеры / Жим ногами | Ввод × 2 + База | Вес блинов с одной стороны |
| **Machine** | Блочные тренажеры | Ввод | Цифра на плитке |
| **Assisted** | Гравитрон | Вес тела − Ввод | Цифра на плитке |
| **Bodyweight** | Свой вес | Вес тела + Ввод | Пояс с гирей (если есть) |
...
- **M: Total_Weight** — нормализованный вес (для аналитики и рекордов)
